...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_THREAD_VERSION_1_2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_LOG_LEVEL_DEBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_LOG_LEVEL, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_COPROCESSOR_UART_RING_BUFFER_SIZE, 4096);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OT_COPROCESSOR_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OT_COPROCESSOR_LOG_LEVEL, 3);
